...
- Have an SSH enabled terminal
  - If you are on Windows, Windows Terminal is recommended
- Have an SSH key pair created
...
- You can access the API with your favorite programming language using the endpoints and tokens denoted in the Sandbox repo. At the time of writing these have the default values of
  - Algod
    - address: ```http://<public-ip>:4001```
    - token: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
  - Kmd
    - address: ```http://<public-ip>:4002```
    - token: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
  - Indexer
    - address: ```http://<public-ip>:8980```
